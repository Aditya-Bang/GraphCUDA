...
@triton_op("graphcuda::fused_spmm_gemm_relu_small_n_switch_loop", mutates_args={})
def fused_spmm_gemm_relu_small_n_switch_loop(
    M: int,
    K1: int,
    BLOCK_M: int,
    adjm_bsr_values_rm: torch.Tensor,
    ...
    wrap_triton(fused_spmm_gemm_relu_small_n_switch_loop_kernel)[grid](
        M, K1, K2, N,
        X, weights, Y,
